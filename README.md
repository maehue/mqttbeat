...
`${GOPATH}/src/github.com/maehue/mqttbeat`
...
```
git remote set-url origin https://github.com/maehue/mqttbeat
...
```
mkdir -p ${GOPATH}/src/github.com/maehue/mqttbeat
git clone https://github.com/maehue/mqttbeat ${GOPATH}/src/github.com/maehue/mqttbeat
```
